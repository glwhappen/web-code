      ...
      <div className="flex max-h-[80vh] w-full max-w-2xl flex-col rounded-lg border border-gray-200 bg-white shadow-xl dark:border-gray-700 dark:bg-gray-800">
        <div className="flex items-center justify-between border-b border-gray-200 p-4 dark:border-gray-700">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              title={t('projectWizard.folderBrowser.toggleCreate')}
            >
          ...
          <div className="border-b border-gray-200 bg-blue-50 px-4 py-3 dark:border-gray-700 dark:bg-blue-900/20">
            <div className="flex items-center gap-2">
              <Input
                ...
                placeholder={t('projectWizard.folderBrowser.newFolderPlaceholder')}
                className="flex-1"
                onKeyDown={(event) => {
                  if (event.key === 'Enter') {
                    handleCreateFolder();
            ...
            <div className="space-y-1">
              ...
              {visibleFolders.length === 0 ? (
                <div className="py-8 text-center text-gray-500 dark:text-gray-400">
                  {t('projectWizard.folderBrowser.empty')}
                </div>
              ) : (
        ...
        <div className="border-t border-gray-200 dark:border-gray-700">
          ...
          <div className="flex items-center justify-end gap-2 p-4">
            ...
            >
              {t('projectWizard.folderBrowser.useCurrent')}
            </Button>
          </div>
        </div>
      </div>
