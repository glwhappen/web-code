import { MessageSquare, Terminal, Folder, GitBranch, ClipboardCheck, Globe, type LucideIcon } from 'lucide-react';
...
const BASE_TABS: BuiltInTab[] = [
  ...
  { kind: 'builtin', id: 'browser', labelKey: 'tabs.browser', icon: Globe },
];
